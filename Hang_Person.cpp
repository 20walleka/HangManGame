...
//find_answer - This method will get the answer word that players will try to guess and will star it out on the screen so no other players can see it
//answer - The answer word that will be guessed
...
//picture_display - This method draws the hang person baised on the number of wrong guesses 
//wrong_guesses - The number of wrong guesses the user has made
...
//answer - The word the players are trying to guess
...
//show_letters - This method shows the blanks and the correctly guessed letters
//letter - The letter the player has guessed
//answer - The word the players are trying to guess
//see_letters - Will allow us to see the letters that have been correctly guessed
